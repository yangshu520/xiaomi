<template>
  <div class="detail">
    <product-param :title="detail.name"></product-param>
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">{{detail.price}}<span class="del">{{detail.price | price}}元</span></div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
          ...
          <div class="item-version clearfix">
            ...
            <div class="phone fr" :class="{'checked':version==2}" @click="version=2">4GB+128GB 移动4G</div>
          </div>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{detail.name}} {{version==1?'6GB+64GB 全网通':'4GB+128GB 移动4G'}} 深灰色</div>
              <div class="fr">￥{{detail.price}}元</div>
            </div>
            <div class="phone-total">总计：{{detail.price}}</div>
          </div>
          <div class="btn-group">
