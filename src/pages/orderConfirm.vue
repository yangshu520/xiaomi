<template>
  <div class="order-confirm">
        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              ...
              <div class="addr-add" @click="addModal">
          ...
          <div class="btn-group">
            <a href="/#/cart" class="btn btn-default btn-large" @click="$router.push('/cart')">返回购物车</a>
    ...
    <modal
    :title="userAction==0?'添加地址':(userAction==1?'编辑地址':'删除地址')"
    btnType='1'
    :showModal="showModal"
    ...
    >
        <template v-slot:body>
            <div>
                <p v-if="userAction==2">您确定要删除该地址吗?</p>
                <div class="edit-wrap" v-if="userAction==0 || userAction==1">
                    <div class="item">
                    ...
                    <div class="item">
                        <input type="text" class="inp" placeholder="邮编地址,选填"  v-model="checkedItem.receiverZip">
                    </div>
                </div>
            </div>
        </template>
  ...
  methods:{
    ...
    getCartList(){
        this.axios.get('/carts').then((res)=>{
            let list =res.cartProductVoList;//获取购物车中所有的数据
    ...
    submitAddress(){
        ...
        if(userAction==0||userAction==2){
            ...
            if(!receiverName){
                ...
                return;
            }else if(!receiverMobile||/\d{12}/.test(receiverMobile)){
            ...
            params={
               receiverName,receiverMobile,receiverProvince,receiverCity,receiverAddress,receiverDistrict,receiverZip
            }
        }
